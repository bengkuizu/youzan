...
<!--日期-->
<div class="date">
<el-tabs type="border-card" id="zong">
...
<!--  微信互动粉色-->
 ...
 <div class="block">
  ...
  <div class="block">
   ...
   <div class="block">
    <span class="demonstration">公众关注时间</span>
    <el-date-picker
      v-model="value25"
      type="date"
      placeholder="开始日期">
  ...
  <div class="block">
    ...
    <el-date-picker
     ...
     <div class="block">
    <span class="demonstration">最近互动时间</span>
    <el-date-picker
      v-model="value27"
      type="date"
      placeholder="开始日期">
...
<div class="tiaojian">重置筛选条件</div>
  <div>
    <el-button @click="show = !show"  class="open">点击</el-button>
...
<!--...........................................................................-->
<el-row type="flex" class="row-bg">
<el-col :span="3">客户身份:</el-col>
  <el-col :span="6">  <el-select v-model="value_a" placeholder="请选择">
    <el-option
  ...
  <el-col :span="3">权益卡:</el-col>
  <el-col :span="6">  <el-select v-model="value_b" placeholder="请选择">
    <el-option
...
<el-col :span="3">性别:</el-col>
  <el-col :span="6">  <el-select v-model="value_c" placeholder="请选择">
    <el-option
  ...
  <el-col :span="3">来源渠道:</el-col>
  <el-col :span="6">  <el-select v-model="value_d" placeholder="请选择">
    <el-option
...
<el-row type="flex" class="row-bg">
<el-col :span="3">来源方式:</el-col>
  <el-col :span="6">  <el-select v-model="value_e" placeholder="请选择">
    <el-option
  ...
  <el-col :span="3">微信地域:</el-col>
  <el-col :span="6">  <el-select v-model="value_f" placeholder="请选择">
    <el-option
...
<el-col :span="3">标签:</el-col>
  <el-col :span="6">  <el-select v-model="value_g" placeholder="请选择">
    <el-option
