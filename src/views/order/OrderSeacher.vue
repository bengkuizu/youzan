...
<el-row type="flex" align="middle">
  <el-col :span="3"><div>商品名称：</div></el-col>
   ...
   <el-col :span="3"><div>订单类型：</div></el-col>
   <el-col :span="7">
   ...
   <el-col :span="3"><div>维权状态：</div></el-col>
    <el-col :span="7">
...
<el-row type="flex" align="middle">
  <el-col :span="3"><div>订单状态：</div></el-col>
   ...
   <el-col :span="3"><div>配送方式：</div></el-col>
   <el-col :span="7">
   ...
   <el-col :span="3"><div>付款方式：</div></el-col>
    <el-col :span="7">
...
<el-row type="flex" align="middle">
  <el-col :span="3"><div>订单来源：</div></el-col>
   <el-col :span="7">
   ...
   <el-col :span="3"><div>是否加星：</div></el-col>
   <el-col :span="7">
   ...
   <el-col :span="3"><div>假的：</div></el-col>
    <el-col :span="7">
